...
export const produceListData: (existingData: any[], existingItems: import("@json-layout/vocabulary").SelectItems, newItems: import("@json-layout/vocabulary").SelectItems) => any;
