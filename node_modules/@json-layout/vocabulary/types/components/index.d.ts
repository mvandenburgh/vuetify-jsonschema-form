 ...
 * @returns {any}
 */
export function getComponentSchema(component: import("../types.js").ComponentInfo): any;
/**
...
export const standardComponents: import("../types.js").ComponentInfo[];
...
export type Card = import("./types.js").Card;
